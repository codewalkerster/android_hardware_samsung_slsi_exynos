...
#define V4L2_DV_BT_CEA_800X480P60 { .type = V4L2_DV_BT_656_1120, V4L2_INIT_BT_TIMINGS(800, 480, 0, V4L2_DV_HSYNC_POS_POL | V4L2_DV_VSYNC_POS_POL, 33900000, 44, 88, 124, 3, 6, 46, 0, 0, 0, V4L2_DV_BT_STD_CEA861, 0) }
#define V4L2_DV_BT_CEA_480X800P60 { .type = V4L2_DV_BT_656_1120, V4L2_INIT_BT_TIMINGS(480, 800, 0, 0, 32000000, 40, 48, 40, 13, 3, 29, 0, 0, 0, V4L2_DV_BT_STD_CEA861, 0) }

#define V4L2_DV_BT_CEA_480X272P60 { .type = V4L2_DV_BT_656_1120, V4L2_INIT_BT_TIMINGS(480, 272, 0, 0, 26170000, 120, 40, 120, 62, 40, 200, 0, 0, 0, V4L2_DV_BT_STD_CEA861, 0) }

#define V4L2_DV_BT_CEA_480X320P60 { .type = V4L2_DV_BT_656_1120, V4L2_INIT_BT_TIMINGS(480, 320, 0, 0, 25200000, 120, 100, 100, 8, 7, 190, 0, 0, 0, V4L2_DV_BT_STD_CEA861, 0) }
...
#define V4L2_DV_BT_CEA_1920X1080P23_976 { .type = V4L2_DV_BT_656_1120, V4L2_INIT_BT_TIMINGS(1920, 1080, 0, V4L2_DV_HSYNC_POS_POL | V4L2_DV_VSYNC_POS_POL,   74175000, 638, 44, 148, 4, 5, 36, 0, 0, 0,   V4L2_DV_BT_STD_CEA861, V4L2_DV_FL_CAN_REDUCE_FPS)  }
...
#define V4L2_DV_BT_DMT_848X480P60 { .type = V4L2_DV_BT_656_1120, V4L2_INIT_BT_TIMINGS(848, 480, 0, V4L2_DV_VSYNC_POS_POL, 31490000, 16, 88, 104, 1, 3, 13, 0, 0, 0, V4L2_DV_BT_STD_DMT, 0) }
#define V4L2_DV_BT_DMT_1024X600P60 { .type = V4L2_DV_BT_656_1120, V4L2_INIT_BT_TIMINGS(1024, 600, 0, V4L2_DV_VSYNC_POS_POL, 50400000, 24, 136, 160, 1, 3, 21, 0, 0, 0, V4L2_DV_BT_STD_DMT, 0) }
...
#define V4L2_DV_BT_DMT_1152X864P75 { .type = V4L2_DV_BT_656_1120, V4L2_INIT_BT_TIMINGS(1152, 864, 0, V4L2_DV_VSYNC_POS_POL, 104990000, 72, 128, 200, 1, 3, 34, 0, 0, 0, V4L2_DV_BT_STD_DMT, 0) }
...
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
#define V4L2_DV_BT_DMT_1280X768P60 { .type = V4L2_DV_BT_656_1120, V4L2_INIT_BT_TIMINGS(1280, 768, 0, V4L2_DV_VSYNC_POS_POL, 80140000, 64, 136, 200, 1, 3, 23, 0, 0, 0, V4L2_DV_BT_STD_DMT | V4L2_DV_BT_STD_CVT, 0) }
...
#define V4L2_DV_BT_DMT_1360X768P60_2 { .type = V4L2_DV_BT_656_1120, V4L2_INIT_BT_TIMINGS(1360, 768, 0, V4L2_DV_VSYNC_POS_POL, 84750000, 64, 144, 208, 1, 3, 23, 0, 0, 0, V4L2_DV_BT_STD_DMT, 0) }
...
#define V4L2_DV_BT_DMT_1400X1050P60 { .type = V4L2_DV_BT_656_1120, V4L2_INIT_BT_TIMINGS(1400, 1050, 0, V4L2_DV_VSYNC_POS_POL | V4L2_DV_HSYNC_POS_POL, 122000000, 88, 152, 240, 2, 12, 18, 0, 0, 0, V4L2_DV_BT_STD_DMT | V4L2_DV_BT_STD_CVT, 0) }
...
#define V4L2_DV_BT_DMT_1600X900P60 { .type = V4L2_DV_BT_656_1120, V4L2_INIT_BT_TIMINGS(1600, 900, 0, V4L2_DV_VSYNC_POS_POL, 119000000, 96, 168, 264, 1, 3, 28, 0, 0, 0, V4L2_DV_BT_STD_DMT, 0) }
...
#define V4L2_DV_BT_DMT_1920X1200P60_RB {   .type = V4L2_DV_BT_656_1120,   V4L2_INIT_BT_TIMINGS(1920, 1200, 0, V4L2_DV_HSYNC_POS_POL,   154000000, 48, 32, 80, 2, 6, 27, 0, 0, 0,   V4L2_DV_BT_STD_DMT | V4L2_DV_BT_STD_CVT,   V4L2_DV_FL_REDUCED_BLANKING)  }
...
#define V4L2_DV_BT_DMT_1200X1920P60 { .type = V4L2_DV_BT_656_1120, V4L2_INIT_BT_TIMINGS(1200, 1920, 0, 0, 154000000, 60, 10, 49, 5, 2, 18, 0, 0, 0, V4L2_DV_BT_STD_DMT | V4L2_DV_BT_STD_CVT, 0) }
...
#define V4L2_DV_BT_DMT_1920X800P60 { .type = V4L2_DV_BT_656_1120, V4L2_INIT_BT_TIMINGS(1920, 800, 0, V4L2_DV_VSYNC_POS_POL, 125590000, 104, 200, 304, 1, 3, 24, 0, 0, 0, V4L2_DV_BT_STD_DMT, 0) }
